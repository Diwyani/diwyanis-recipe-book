...
import { timeLevel, costLevel } from "@/lib/levels";
        ...
        <div className="flex items-start gap-4 sm:hidden">
          ...
          <div className="flex-1 flex flex-col gap-1.5 text-left min-w-0 pt-1">
            ...
            <div className="flex flex-wrap gap-2">
              {recipe.time_minutes && (
                <span className="flex items-center gap-1 text-[0.65rem] uppercase tracking-wide text-recipe-navy">
            ...
            <button
              ...
              className={`rounded-full px-3 py-1 text-[0.65rem] uppercase tracking-wide transition-colors duration-200 ${
                activeCategory === cat
                  ...
                  : "bg-transparent text-recipe-navy/60 hover:text-recipe-navy"
              }`}
            >
              {cat}
            </button>
